...
export default function sitemap(): MetadataRoute.Sitemap {
  const posts = blogPosts.map((post) => ({
    url: `https://aarongeorge.dev/blog/${post.slug}`,
  ...
  return [
    ...
    {
      url: 'https://aarongeorge.dev/blog',
      lastModified: new Date(),
      changeFrequency: 'weekly',
      priority: 0.9,
    },
...
<rss version="2.0">
  <channel>
    <title>Aaron George Blog</title>
    <link>https://aarongeorge.dev/blog</link>
    ...
    <item>
      ...
      <link>https://aarongeorge.dev/blog/${post.slug}</link>

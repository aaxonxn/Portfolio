...
\`\`\`bash
# Clone repository
git clone https://github.com/aaxonxn/portfolio.git
cd Aaron George
...
export const metadata: Metadata = {
  title: 'About | Aaron George',
  description: 'About Aaron George and this digital laboratory',
}
...
- **GitHub Issues**: https://github.com/aaxonxn/portfolio/issues

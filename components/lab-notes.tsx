...
const notes = [
  {
    id: 1,
    title: "Real-Time Emotion Detection with CNNs",
    excerpt: "Designing an end-to-end pipeline for facial emotion recognition using OpenCV, TensorFlow, and convolutional neural networks.",
    date: "Dec 2025",
  ...
  {
    id: 2,
    title: "Building RAG Chatbots with Zero Hallucination",
    excerpt:
      "Implementing semantic search with sentence-transformers and pgvector for accurate, traceable PDF Q&A with exact source citations.",
    date: "Jun 2025",
    category: "ai",
  ...
  {
    id: 3,
    title: "MCP Protocol for AI-Driven 3D Workflows",
    excerpt: "Developing an MCP-compliant server to enable AI models to interact programmatically with Blender for procedural modeling and automation.",
    date: "Ongoing",
    category: "ai/systems",
  ...
  {
    id: 4,
    title: "Cyber Security Fundamentals at IIIT Kottayam",
    excerpt: "Exploring cryptography principles, encryption, hashing, common vulnerabilities, and defensive mechanisms in computing systems.",
    date: "Jun 2025",
    category: "security",

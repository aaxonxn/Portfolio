...
const projects = [
  {
    id: 0,
    title: "Emotion Detection System – Protek",
    description:
      "Real-time facial emotion recognition system using CNN-based deep learning. Implements an end-to-end pipeline covering face detection, feature extraction, and emotion classification with OpenCV for real-time video processing.",
  ...
  {
    id: 1,
    title: "AI-Powered PDF Preprocessor & Chatbot",
    description:
      "Advanced RAG PDF processing chatbot with zero-tolerance for hallucination. Answers queries while displaying exact PDF pages and sources, supports any PDF format including Sanskrit texts with OCR capabilities.",
    tags: ["FastAPI", "Google Cloud Vision", "Gemini AI", "Supabase", "PostgreSQL", "Docker"],
    status: "shipped",
    year: "2025",
    stars: 0,
    forks: 0,
  ...
  {
    id: 2,
    title: "MCP Server for Blender",
    description:
      "MCP-compliant server enabling AI models to interact programmatically with Blender. Exposes scene control, object creation, transformations, and rendering as MCP tools for AI-assisted 3D workflows.",
    tags: ["Python", "FastAPI", "Blender API", "MCP", "JSON-RPC", "LLM APIs"],
    status: "in-progress",
    year: "2025",
    stars: 0,
    forks: 0,

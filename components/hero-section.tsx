...
const roles = ["building AI systems", "exploring computer vision", "crafting full-stack apps", "developing ML models", "engineering solutions"]
          ...
          <div className="space-y-8 sm:space-y-10">
            <div className="space-y-3 animate-fade-in-up">
              <p className="font-mono text-xs uppercase tracking-[0.25em] sm:tracking-[0.35em] text-primary">
                Aaron George — AI & Computer Science
              </p>
            ...
            <p className="max-w-lg text-base sm:text-lg leading-relaxed text-muted-foreground animate-fade-in-up stagger-2">
              Computer Science undergraduate specializing in Artificial Intelligence, with hands-on experience in AI-based
              projects. Skilled in programming, machine learning, and computer vision, with working knowledge of cyber security.
            </p>

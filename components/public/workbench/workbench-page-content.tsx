...
const wipItems = [
  {
    ...
    description: "MCP Server for Blender enabling AI-assisted 3D modeling workflows via protocol integration",
    progress: 55,
    lastUpdated: "Jan 2025",
    url: "https://github.com/aaxonxn/mcp-server-blender",
    branch: "main",
    commits: 23,
  },
  {
    id: 2,
    name: "emotion-detection-protek",
    description: "Real-time emotion detection system using CNNs with OpenCV face detection pipeline",
    progress: 90,
    lastUpdated: "Dec 2024",
    url: "https://github.com/aaxonxn/emotion-detection-protek",
    branch: "main",
    commits: 67,
  },
  {
    ...
    description: "AI-powered PDF preprocessor and chatbot with RAG architecture and zero-hallucination guarantees",
    progress: 85,
    lastUpdated: "Nov 2024",
    url: "https://github.com/aaxonxn/pdf-chatbot-rag",
    branch: "main",
    commits: 45,
  },
]
...
const recentActivity = [
  { type: "commit", project: "mcp-server-blender", message: "Add scene inspection handlers", time: "2 hours ago" },
  { type: "branch", project: "emotion-detection-protek", message: "Created feature/multi-face branch", time: "5 hours ago" },
  { type: "commit", project: "pdf-chatbot-rag", message: "Optimize vector search performance", time: "1 day ago" },
  { type: "commit", project: "mcp-server-blender", message: "Implement material assignment protocol", time: "2 days ago" },
]
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <div className="flex items-center gap-3 border-b border-border/50 bg-secondary/40 px-4 sm:px-5 py-3.5 sm:py-4">
                ...
                <span className="ml-4 font-mono text-xs text-muted-foreground truncate">~/aarongeorge/active</span>

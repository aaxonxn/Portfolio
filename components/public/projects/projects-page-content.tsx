...
const projects = [
  {
    ...
    description:
      "Real-time emotion detection using CNNs with OpenCV-based face detection pipeline. Classifies 7 emotional states from live video feeds with optimized inference.",
  ...
  },
  {
    ...
    description:
      "Full-stack RAG chatbot that preprocesses PDF documents, builds semantic search indexes, and answers questions with zero-hallucination guarantees.",
    tags: ["Python", "FastAPI", "Supabase", "Docker", "RAG"],
    status: "shipped",
    year: "2024",
    stars: 0,
    forks: 0,
  ...
  },
  {
    ...
    description:
      "MCP protocol server enabling AI-assisted 3D modeling workflows with Blender. Bridges AI models with 3D creation tools for automated scene manipulation.",
    tags: ["Python", "MCP Protocol", "Blender", "AI Integration"],
    status: "in-progress",
    year: "2025",
    stars: 0,
    forks: 0,

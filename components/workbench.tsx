...
const wipItems = [
  {
    ...
    description: "MCP-compliant server enabling AI models to interact programmatically with Blender for 3D workflows",
    progress: 60,
    lastUpdated: "2025",
  ...
  },
  {
    ...
    description: "Real-time facial emotion recognition using CNN-based deep learning with OpenCV",
    progress: 95,
  ...
  },
  {
    ...
    description: "AI-powered PDF preprocessor & chatbot with zero-hallucination RAG and OCR capabilities",
    progress: 90,
